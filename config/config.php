...
define("COOKIE_DOMAIN", "Toy4Exchange.com");
...
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "prudhviraj.sql@gmail.com");
define("EMAIL_SMTP_PASSWORD", "myp@ssw0rd");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "localhost:90/Demo/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "prudhviraj.sql@gmail.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Support");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password Reset - Toy4Exchange");
define("EMAIL_PASSWORDRESET_CONTENT", "Please click the link below to reset your password:");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "localhost:90/Demo/register.php");
define("EMAIL_VERIFICATION_FROM", "prudhviraj.sql@gmail.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Support");
define("EMAIL_VERIFICATION_SUBJECT", "Account Activation - Toy4Exchange");
define("EMAIL_VERIFICATION_CONTENT", "Please click the link below to activate your account:");
 ...
 * the cost factor, to make the password hashing one step more secure.
 *
