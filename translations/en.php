...
define("MESSAGE_PASSWORD_EMPTY", "Password field cannot be empty");
define("MESSAGE_DOB_EMPTY", "DOB field cannot be empty");
define("MESSAGE_AGE_RESTRICTION", "You should be atleast 18 years old to register an account.");
...
define("WORDING_REGISTRATION_CAPTCHA", "Please enter these characters in the box provided below");
