...
for ($i = 0; $i < $iCaptchaLength; $i++) {
    ...
    //imagefttext($im, 35, rand(-10, 10), 20 + ($i * 30) + rand(-5, +5), 35 + rand(10, 30), $text_color, 'fonts/Akashi.ttf', $str_captcha[$i]);
    imagefttext($im, 30, 0, 20 + ($i * 30) + rand(-5, +5), 35 , $text_color, 'fonts/Akashi.ttf', $str_captcha[$i]);
}
